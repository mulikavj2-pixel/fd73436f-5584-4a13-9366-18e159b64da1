...
export const metadata: Metadata = {
  title: "AutoDrive | Premium Car Dealership & Vehicles",
  description: "Discover quality vehicles at AutoDrive. Browse our premium car inventory, financing options, and expert service. Your trusted automotive partner.",
  keywords: "car dealership, buy cars online, vehicle inventory, auto financing, premium cars",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "AutoDrive | Premium Vehicle Selection",
    description: "Find your perfect vehicle at AutoDrive - trusted car dealership with quality inventory and excellent customer service.",
    type: "website",
    siteName: "AutoDrive"
  }
};
